...
describe User do
  ...
  describe "#get_chore_lists_by_date" do
    it { should respond_to(:get_chore_lists_by_date) }
    context "given 6 ChoreLists across 3 different dates" do
      let(:output) { subject.get_chore_lists_by_date }
      before do
